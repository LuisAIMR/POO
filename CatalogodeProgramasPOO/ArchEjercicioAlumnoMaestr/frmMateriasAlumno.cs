...
{
    public partial class frmMateriasAlumno : Form
    {
        ...
        private void btnAgregarMaterias_Click(object sender, EventArgs e)
        {
            ...
            if (contador < cantidadMaterias)
            {
                ...
                if (ObjAlumno.Materias.Length != 1000)
                {
                    ...
                    almacenador += ObjAlumno.Materias[contador] + "\n";
                    almacenador += "Calificacion de la materia: ";
                ...
                else
                {
                    ...
                    almacenador += "\n" + "Materia numero [" + (contador) + "]" + "\n";
                    almacenador += "Nombre de la materia: ";
                    ObjAlumno.Materias[0] = txtMateria.Text;
                    almacenador += ObjAlumno.Materias[0] + "\n";
                    almacenador += "Calificacion de la materia: ";
                    ...
                    almacenador += ObjAlumno.Calificacion[0] + "\n";
                    MessageBox.Show("Materia Agregada", "Materias", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    LimpiarControles();
                }
        ...
        {
            alumno = new StreamWriter("datosAlumno.txt");
