...
{
    public partial class frmMateriasImpartidasMaestro : Form
    {
        ...
        public frmMateriasImpartidasMaestro()
        {
            InitializeComponent();
        }

        private void frmMateriasImpartidasMaestro_Load(object sender, EventArgs e)
        {
